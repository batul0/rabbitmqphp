...
(function(){
  ...
  // small helpers (match your other sections)
  ...
  async function loadRecommendations() {
    ...
    try {
      // your web server proxy that talks to loginServer -> DMZ
      const r = await fetch('recommendations.php?_=' + Date.now(), { method: 'GET', credentials: 'include' });
  ...
  // expose for router + hook refresh button
